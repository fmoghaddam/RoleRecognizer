...
//
//import evaluation.GroundTruchProvider;
...
//
//	private static Logger LOG = Logger.getLogger(EvaluatorModified.class);
//
...
//
//	public EvaluatorModified() throws IOException {
//
...
//					final Set<Category> categories = roleProvider.getValues().get(candicateText);
//					if (categories != null) {
...
//		resetMetrics();
//
//		final Map<String, Set<Category>> generateNERDictionary = NERTagger.generateDictionary(roleProvider.getValues());
//
//		for(GroundTruthFile groundTruthFile:groundTruthProvider.getData()){
//			for(Entry<Category, List<Tuple<String, String>>> entry:groundTruthFile.getData().entrySet()){
//				final Category category = entry.getKey();
